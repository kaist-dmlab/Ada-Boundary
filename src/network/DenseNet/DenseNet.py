...
class DenseNet(object):
    def __init__(self, depth, growthRate, image_shape, num_labels, train_batch_size, test_batch_size):
    ...
    def build_train_op(self, lr_boundaries, lr_values, optimizer_type):
        ...
        return self.train_loss, self.train_accuracy, train_op, loss, distance
